...
Backend Engineer focused on building scalable and reliable systems. Strong experience with TypeScript, Node.js, NestJS, AWS (Lambda, DynamoDB, S3, SQS/SNS), event-driven architectures, and workflow orchestration. Used to working with distributed systems, asynchronous communication, and infrastructure as code.
